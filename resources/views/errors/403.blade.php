...
<body id="kt_body" class="app-blank app-blank bgi-size-cover bgi-position-center bgi-no-repeat">
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <style>
            body {
                background-image: url('assets/media/auth/bg11.jpg');
            }

            [data-bs-theme="dark"] body {
                background-image: url('assets/media/auth/bg11-dark.jpg');
            }
        </style>
        <!--end::Page bg image-->
            ...
            <div class="d-flex flex-column flex-center text-center p-10">
                ...
                <div class="card card-flush w-lg-650px py-5">
                    <div class="card-body py-15 py-lg-20">
                        <!--begin::Title-->
                        <h1 class="fw-bolder fs-2qx text-gray-900 mb-4">Forbidden!</h1>
                        <!--end::Title-->
                        <!--begin::Text-->
                        <div class="fw-semibold fs-6 text-gray-500 mb-7">
                            You are not permitted to enter this page. Please return to be safe
                        </div>
                        <!--end::Text-->
                        <!--begin::Illustration-->
                        <div class="mb-11">
                            <img src="assets/media/auth/coming-soon.png" class="mw-100 mh-300px theme-light-show"
                                alt="" />
                            <img src="assets/media/auth/coming-soon-dark.png" class="mw-100 mh-300px theme-dark-show"
                                alt="" />
                        </div>
                        <!--end::Illustration-->
                        <!--begin::Link-->
