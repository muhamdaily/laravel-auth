<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <div class="app-sidebar-footer flex-column-auto pt-2 pb-6 px-6" id="kt_app_sidebar_footer">
        <a href="https://api.whatsapp.com/send?phone=6285748497255&text=Halo%2C%20saya%20membutuhkan%20bantuan%20untuk%20aplikasi%20*esemka*"
            class="btn btn-flex flex-center btn-custom btn-primary overflow-hidden text-nowrap px-0 h-40px w-100"
            data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss-="click" title="Hubungi pengembang"
            target="_blank">
            <i class="ki-duotone ki-whatsapp text-success fs-2 m-0">
                <span class="path1"></span>
                <span class="path2"></span>
            </i>
